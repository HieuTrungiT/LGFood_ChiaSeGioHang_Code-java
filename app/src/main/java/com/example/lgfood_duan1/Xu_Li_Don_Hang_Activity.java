...
//        xuLi_cardView_heartItem=findViewById(R.id.xuLi_cardView_heartItem);
        xuLi_cardView_message=findViewById(R.id.xuLi_cardView_message);
        xuLi_cardView_btnXacNhan=findViewById(R.id.xuLi_cardView_btnXacNhan);
        xuLi_txt_tenKhachHang=findViewById(R.id.xuLi_txt_tenKhachHang);
        xuLi_txt_sdtKhachHang=findViewById(R.id.xuLi_txt_sdtKhachHang);
